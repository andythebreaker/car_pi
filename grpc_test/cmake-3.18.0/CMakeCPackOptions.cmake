...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release\\CMakeInstall.bmp")
...
include("/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_TEMPLATE
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Source/QtIFW/installscript.qs.in")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_GENERATED
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/CMake.qs")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright;/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Copyright.txt")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/CMake.Dialogs.QtGUI.qs")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/CMake.Documentation.SphinxHTML.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/install_dir.wxs"
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/home/wp2018/user/andythebreaker/car_pi/grpc_test/cmake-3.18.0/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
